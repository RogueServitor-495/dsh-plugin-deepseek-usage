...
/**
 * Supported providers for account/usage display. "auto" follows the model
 * selected in the current conversation (mapped per model/provider id).
 */
export const PROVIDER_CHOICES = Object.freeze(["auto", "deepseek", "zhipu", "kimi"]);
